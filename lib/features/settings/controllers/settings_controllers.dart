...
import 'package:get/get.dart'; // <-- IMPORT TAMBAHAN 1
import '../../../features/dashboard/controllers/dashboard_controllers.dart'; // <-- IMPORT TAMBAHAN 2
...
class SettingsController {
  ...
  void endSession(BuildContext context) async {
    ...
    await _storageService.delete('locationName');
    await _storageService.delete('locationImage');
    await _storageService.delete('apiLocationCode');

    // --- PERBAIKAN UTAMA DI SINI ---
    // Hapus instance DashboardController dari memori GetX.
    // Ini akan memaksa aplikasi membuat controller baru saat login kembali.
